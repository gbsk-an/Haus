    ...
    <div class="cart-item_body">
      ...
      <div class="product-qty">
        ...
        <div class="product-qty_value">
          <button @click="qtyMinus" type="button" class="product-qty_value-btn">
            -
          </button>
          <span class="product-qty_value-total">{{
            cart_item_data.quantity
          }}</span>
          <button @click="qtyPlus" type="button" class="product-qty_value-btn">
            +
          </button>
        </div>
      </div>
